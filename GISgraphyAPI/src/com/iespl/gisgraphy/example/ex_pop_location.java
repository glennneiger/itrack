...
public class ex_pop_location {
	public static void main(String[] argv){
		...
		int rad=200;
		System.out.println("Location VIA latlng Array ");
		...
		class_pop_location loc_lat_lng= new class_pop_location(latlngArray,rad);
		
		ArrayList<LatLng>  data = loc_lat_lng.getLatlngData();
		...
		System.out.println("Location VIA code ");
		
		//System.out.println("start time to get"+System.currentTimeMillis());
		String[] dbcodevalues = {"20000002", "20000001"};
		...
		class_pop_location loc_code= new class_pop_location(CodeArray);
		
		ArrayList<LatLng>  values2 = loc_code.getLatlngData();
