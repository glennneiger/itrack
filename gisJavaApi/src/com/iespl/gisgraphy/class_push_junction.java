...
public class class_push_junction {
	...
	public class_push_junction(ArrayList<DocumentPushJunction> dataJunction){
				 ...
				 if(dataJunction.size()>0)
				 	{ 
					 	for(DocumentPushJunction data : dataJunction){
					        ...
					        String queryInsert="insert into Road (countrycode, featureid, featureclass, featurecode, location, name, modificationdate, source, id) values ('"+countrycode+"',"+new_max_gid+",'"+featureclass+"','"+featurecode+"','"+locationbase+"','"+name+"','"+modificationdate+"','"+source+"',"+new_max_id+")";
