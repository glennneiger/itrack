...
public class ex_push_location {
	...
	public static void main(String[] argv){
		...
		featurecode="ST"; //(FIXED)junction
		placetype="GisFeature"; //(FIXED) please note ROAD is not actual road and junction type is road and is fixed
