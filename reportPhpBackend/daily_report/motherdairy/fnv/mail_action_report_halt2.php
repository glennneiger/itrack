                ...
                //while(!feof($xml))          // WHILE LINE != NULL
                {
					...
					echo "\nIn Plant";
                                        ...
                                        {																			
                                            ...
                                            $schedule_in_time_tmp2 = $ScheduleInTime2[$m];	 //PLANT IN SCHEDULE
					  ...
					  if( ($schedule_point_tmp2 == $station_no) && ($route_from_vehicle == $vname) )
                                            {                              
                                                ...
                                                //###### GET PLANT -IN DELAY
                                                $schedule_in_time = $schedule_in_time_tmp2;																			
                                                ...
                                                {											
                                                    ...
                                                    {															
                                                        $hms_3 = secondsToTime($time1);
                                                        $time_delay_p1 = $hms_3[h].":".$hms_3[m].":".$hms_3[s];
                                                    }
                                                    else
                                                    {
                                                        //time_delay = "00:00:00";
                                                        $time1 = abs($time1);
                                                        $hms_4 = secondsToTime($time1);								
                                                        $time_delay_p1 = $hms_4[h].":".$hms_4[m].":".$hms_4[s];
                                                        $time_delay_p1 = "-".$time_delay_p1;
                                                    }
                                                }

                                                //##### GET PLANT -OUT DELAY
                                                $schedule_out_time = $schedule_out_time_tmp2;											

                                                if($schedule_out_time!="")
                                                {
                                                    $tmp_time_output = $start_date_tmp[0]." ".$start_date_tmp[1];
                                                    $tmp_time_schedule = $start_date_tmp[0]." ".$schedule_out_time;

                                                    $tmp_output = strtotime($tmp_time_output);
                                                    $tmp_schedule = strtotime($tmp_time_schedule);

                                                    $final_date = "";
                                                    if($tmp_output <= $tmp_schedule)
                                                    {
                                                            $final_date = $start_date_tmp[0];
                                                    }								
                                                    else
                                                    ...
                                                    //echo "\nScheduleInTime=".$schedule_in_time;											
                                                    $out_time_str_excel = $final_date." ".$schedule_out_time;
                                                    $out_time_str = $depature_time;
                                                    ...
                                                    {															
                                                            $hms_3 = secondsToTime($time1);
                                                            $time_delay_p2 = $hms_3[h].":".$hms_3[m].":".$hms_3[s];
                                                    }
                                                    else
                                                    {
                                                            //time_delay = "00:00:00";
                                                            $time1 = abs($time1);
                                                            $hms_4 = secondsToTime($time1);								
                                                            $time_delay_p2 = $hms_4[h].":".$hms_4[m].":".$hms_4[s];
                                                            $time_delay_p2 = "-".$time_delay_p2;																					
                                                    }
                                                }	
                                    ...
                                    if(($type_str=='Customer') || ($schedule_in_time_tmp2=="") || ($schedule_out_time_tmp2==""))
                                    {
                                        $time_delay_p1 = "-";
                                        $time_delay_p2 = "-";
                                        $schedule_in_time_tmp2 ="-";
                                        $schedule_out_time_tmp2 ="-";
                                    }
