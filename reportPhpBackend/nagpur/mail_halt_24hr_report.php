...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_(MOTHER_NAGPUR)_'.$previous_date."_".$inc_serial;
	...
	########### SEND MAIL ##############//
	$to = 'dattatray.jankar@motherdairy.com,anand.arondekar@motherdairy.com,Logistics.Vashi@motherdairy.com,Logistics.Nagpur@motherdairy.com,vivek.ghadge@motherdairy.com,vaibhav.madkar@motherdairy.com';
	...
	$subject = 'BETA::VTS_HALT_REPORT_(MOTHER_NAGPUR)_'.$previous_date;
	$message = 'BETA::VTS_HALT_REPORT_(MOTHER_NAGPUR)_'.$previous_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply to this email***</font>"; 
	...
	$file_path = $fullPath.".xls";
        ...
        $result = $mgClient->sendMessage($domain, array(
            ...
            'to' => $to,
            'cc'      => 'jyoti.jaiswal@iembsys.com,rizwan@iembsys.com',
